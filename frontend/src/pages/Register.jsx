            ...
            <div className="relative w-full max-w-md">
                <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 shadow-2xl">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-zinc-400 mt-2 text-sm text-center">Sign up to get started with Vortex Admin Pro</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    name="username"
                                    required
                                    className="block w-full pl-11 pr-4 py-3 bg-zinc-950/50 border border-zinc-800 rounded-2xl text-white placeholder-zinc-500 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all outline-none"
                                    placeholder="johndoe"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 py-3.5 px-4 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-70 disabled:hover:bg-indigo-600 text-white font-medium rounded-2xl transition-all active:scale-[0.98] shadow-lg shadow-indigo-600/20 mt-8"
                        >
                        ...
                        <div className="mt-6 grid grid-cols-3 gap-3">
                            <a href="http://localhost:8080/oauth2/authorization/google" className="flex items-center justify-center py-2.5 bg-zinc-950/50 border border-zinc-800 rounded-xl hover:bg-zinc-800 transition-colors">
                                <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" className="h-5 w-5" />
                            </a>
                            <a href="http://localhost:8080/oauth2/authorization/github" className="flex items-center justify-center py-2.5 bg-zinc-950/50 border border-zinc-800 rounded-xl hover:bg-zinc-800 transition-colors">
                                <img src="https://www.svgrepo.com/show/512317/github-142.svg" alt="GitHub" className="h-5 w-5 filter invert opacity-80" />
                            </a>
                            <a href="http://localhost:8080/oauth2/authorization/microsoft" className="flex items-center justify-center py-2.5 bg-zinc-950/50 border border-zinc-800 rounded-xl hover:bg-zinc-800 transition-colors">
