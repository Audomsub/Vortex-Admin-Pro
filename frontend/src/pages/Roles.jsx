...
import { 
    Shield, Key, Users, Settings, Plus, Check, Save, Info, X, Loader2
} from 'lucide-react';
...
const Roles = () => {
    ...
    const actionHeaders = ['read', 'create', 'update', 'delete', 'manage', 'export'];
        ...
        <Layout>
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 p-4 lg:p-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-text-primary tracking-tight">Roles & Permissions</h1>
                        <p className="text-text-secondary mt-1 text-sm">Manage what users can see and do within the application.</p>
                    </div>
                    <button 
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 bg-surface rounded-2xl border border-border">
                        ...
                        <p className="text-text-secondary">Loading roles & permissions...</p>
                    </div>
                ) : (
                        ...
                        <div className="lg:col-span-4 space-y-4">
                            <div className="bg-surface p-4 rounded-2xl border border-border shadow-sm">
                                <h2 className="font-semibold text-text-primary mb-4 flex items-center gap-2">
                                    <Shield size={18} className="text-primary" /> Active Roles
                                </h2>
                            ...
                            <div className="bg-surface rounded-2xl border border-border shadow-sm flex flex-col h-full overflow-hidden">
                                <div className="p-6 border-b border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-text-secondary mt-1">Check the boxes below to assign permissions.</p>
                                    </div>
                                    <button 
                                ...
                                <div className="p-4 bg-background border-t border-border flex gap-3 text-sm text-text-secondary items-start">
                                    ...
                                    <p>SUPER_ADMIN roles have all permissions implicitly granted. You cannot modify them here to prevent accidental system lockouts.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="fixed inset-0 z-50 flex items-start justify-center p-4 pt-24 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-surface rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="px-6 py-4 border-b border-border flex justify-between items-center">
                            <h3 className="font-bold text-lg text-text-primary">Create New Role</h3>
